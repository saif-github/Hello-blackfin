...
namespace VDK
{
	...
	{
		INIT_THREADTEMPLATE_("kP_thread1",kPriority5, 255,  ::P_thread1_Wrapper::Create  ,ksystem_heap ,ksystem_heap,false),
		INIT_THREADTEMPLATE_("kP_thread2",kPriority6, 255,  ::P_thread2_Wrapper::Create  ,ksystem_heap ,ksystem_heap,false)
	};
...
HeapID g_IOObjectHeap = ksystem_heap;
	...
	{ 
		{ &g_ThreadTemplates[kP_thread1], 0 }
	}; 
	...
	float g_ClockFrequency = 500000.000;

	unsigned int g_ClockPeriod = 50000;
	...
	extern const unsigned int kMaxNumActiveSemaphores=4;
	VDK::IDTableElement g_SemIDElements[4 + 1];
	SemaphoreTable g_SemaphoreTable = {g_SemIDElements, 4};
