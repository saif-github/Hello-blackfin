...
#define VDK_INSTRUMENTATION_LEVEL_ 0
...
#define kP_thread1 0	/* enum */
#define kP_thread2 1	/* enum */
#endif 	/* __ECC__ */
...
#define VDK_kMaxNumActiveSemaphores 4
