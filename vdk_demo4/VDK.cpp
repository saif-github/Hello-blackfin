...
namespace VDK
{
	...
	{
		INIT_THREADTEMPLATE_("km_thread1",kPriority5, 255,  ::m_thread1_Wrapper::Create  ,ksystem_heap ,ksystem_heap,true),
		INIT_THREADTEMPLATE_("kmthread2",kPriority5, 255,  ::mthread2_Wrapper::Create  ,ksystem_heap ,ksystem_heap,true)
	};
...
HeapID g_IOObjectHeap = ksystem_heap;
	...
	{ 
		{ &g_ThreadTemplates[km_thread1], 0 }
	}; 
	 ...
	 *	Memory Pools:
	 */					
	extern const unsigned int kMaxNumActiveMemoryPools=1;
	...
	float g_TickPeriod = .05;

	float g_ClockFrequency = 500000.000;

	unsigned int g_ClockPeriod = 25000;
...
#ifdef VDK_INCLUDE_MESSAGES_
	extern const unsigned int kMaxNumActiveMessages=10;
